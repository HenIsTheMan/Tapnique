...
namespace Genesis.Wisdom {
	...
	internal sealed class EnumRangePropertyDrawer: PropertyDrawer {
		public override void OnGUI(Rect pos, SerializedProperty property, GUIContent label) {
			...
			List<int> enumValIndexList = ((EnumRangeAttribute)attribute).enumValIndexList;
			string[] nameArr = ((EnumRangeAttribute)attribute).nameList?.ToArray();

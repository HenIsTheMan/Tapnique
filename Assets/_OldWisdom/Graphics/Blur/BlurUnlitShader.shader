Shader "MyUnlitShaders/BlurUnlitShader" {
	Properties{
		...
		[PowerSlider(3)] _StandardDeviation("Standard Deviation (Gauss only)", Range(0.0, 0.3)) = 0.3
	}
